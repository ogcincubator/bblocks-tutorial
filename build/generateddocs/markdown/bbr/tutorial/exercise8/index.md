...
- run build
- run viewer
- navigate to [Transforms](bblocks://ogc.bbr.tutorial.exercise8/transforms) Tab
...
- navigate to [Examples](bblocks://ogc.bbr.tutorial.exercise8/examples) Tab
...
```jsonld
{
  "@context": "https://ogcincubator.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise8/context.jsonld",
  "one": 1,
  "two": 2,
  "string": "value"
}
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise8/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise8/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise8/context.jsonld)
