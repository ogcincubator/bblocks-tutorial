...
# 08 - Transforms (completed) (Schema)

`ogc.bbr.tutorial.exercise8_completed` *v0.1*
...
- run build
- run viewer
- navigate to [Transforms](bblocks://ogc.bbr.tutorial.exercise8_completed/transforms) Tab
...
- navigate to [Examples](bblocks://ogc.bbr.tutorial.exercise8_completed/examples) Tab
...
```jsonld
{
  "@context": "https://ogcincubator.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise8_completed/context.jsonld",
  "one": 1,
  "two": 2,
  "string": "value"
}
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise8_completed/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise8_completed/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/bblocks-tutorial/build/annotated/bbr/tutorial/exercise8_completed/context.jsonld)
...
* Path: `_sources/exercise8_completed`
