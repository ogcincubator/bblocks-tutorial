...
# 11 - Profiling an Ontology (Model)

`ogc.bbr.tutorial.exercise11` *v0.1*
...
- run build
- run viewer
- navigate to [validation](validation) tab and see inheritance of rules from Exercise 10
